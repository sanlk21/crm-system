        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-3 mb-8">
                    <!-- Customer Count -->
                    <div
                        class="bg-white shadow-sm sm:rounded-lg p-6 flex items-center space-x-4"
                    >
                        ...
                        <div class="text-gray-600">
                            ...
                            >
                                <path
                                    ...
                                    stroke-linejoin="round"
                                    stroke-width="2"
                                    d="M9 17v-2a2 2 0 012-2h2a2 2 0 012 2v2m-6 0h6m-3-9h.01M12 3a9 9 0 100 18 9 9 0 000-18z"
                                ></path>
                            </svg>
                        </div>
                        <div>
